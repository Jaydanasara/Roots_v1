            ...
            {this.state.allUserPost.map(each => {
              return (
                ...
                <div className="friendsPostinfo">
                 <Link to={"/screenProfile/"+each.user_ID }><img className="friendsImg" src={(each.post_by_pic!==undefined) ? each.post_by_pic: "https://firebasestorage.googleapis.com/v0/b/roots-6f3a0.appspot.com/o/admin%2FlogoTransparent.png?alt=media&token=cdaf21c0-865e-4aca-afc7-6380cbe07802"} alt="friendspic" /> </Link> 
...
<div className="mapComments">{
                                                ...
                                                <div className={(this.state.comOption_id === comment._id) ? "comOptionsContainer active" : "comOptionsContainer"} onClick={() => this.commentOptions(comment._id)} >
                                                    <button type="button" className="commentOptions" ><i class="far fa-comment-dots"></i></button>

            ...
            this.state.isLoading === true ? <div className="loading">Loading</div> :
                <div className="app-container">
                    ...
                    <section className="content-Container">
                        ...
                        <ScrFriends userInfo={this.props.userInfo} screenInfo={this.state.screenNameInfo} saveNotification={this.saveNotification} notiPost={this.state.notiPost} isNotiOpen={this.state.isNotiOpen}
